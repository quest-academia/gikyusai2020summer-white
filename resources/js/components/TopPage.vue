...
.alcohol001 p,.alcohol002 p,.alcohol003 p,.alcohol004 p{
  margin: 0;
  padding: 0;
  color: #5D5D5E;
  font-family: 'Kosugi Maru', sans-serif;
...
/*相性がいいおつまみ設定*/
.alcohol001 img,.alcohol002 img,.alcohol003 img,.alcohol004 img{
  width: 90px;
  height: 90px;
}
